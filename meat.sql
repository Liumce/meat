...
CREATE TABLE `t_comment` (
  ...
  `fdate` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE current_timestamp() COMMENT '评论时间',
...
CREATE TABLE `t_post` (
  ...
  `fdate` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE current_timestamp() COMMENT '发表时间',
  `udate` datetime DEFAULT NULL ON UPDATE current_timestamp() COMMENT '修改时间',
